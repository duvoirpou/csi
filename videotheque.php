        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-1.jpg);">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">videothèque</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                           <li class="breadcrumb-item"><a href="index.php">Accueil</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">videothèque</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5" align="center">
            <div class="container">
                ...
                <div class="row g-4" align="center">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" align="center">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                           				                       <video controls width="100%">
  <source src="video/Formation VATEL juin 2024 03.mp4" type="video/mp4" />

  <source src="video/Formation VATEL juin 2024 03.mp4" type="video/mp4" />

  Download the
  <a href="video/Formation VATEL juin 2024 03.mp4">WEBM</a>     
  or
  <a href="video/Formation VATEL juin 2024 03.mp4">MP4</a>
  video.
</video><h6 align="center">Formation VATEL juin 2024 </h6>
                           </div>
					...
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" align="center">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
															   ...
															   <video controls width="100%">
  <source src="video/Séminaire Banque Postale du Congo nov 2023_6.mp4" type="video/mp4" />

  <source src="video/Séminaire Banque Postale du Congo nov 2023_6.mp4" type="video/mp4" />

  Download the
  <a href="video/Séminaire Banque Postale du Congo nov 2023_6.mp4">WEBM</a>     
  or
  <a href="video/Séminaire Banque Postale du Congo nov 2023_6.mp4">MP4</a>
  video.
</video>
<h6 align="center">Séminaire Banque Postale du Congo novembre 2023</h6>
                 ...
                 <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <iframe width="500" height="275" src="video/Formation VATEL juin 2024 03.mp4" title="LE DISCOURS INSPIRANT DU MILLIARDAIRE JACK MA AUX ENTREPRENEUR - (motivation francais)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
